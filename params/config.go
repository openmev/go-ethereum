...
type ChainConfig struct {
	...
	OpenMevBlock	    *big.Int `json:"openmevBlock,omitempty"`.       // @openemv @param openmevBlock,omitempty @returns {big.Int}
...
// @openmev IsOpenMev returns whether num is either equal to the London fork block or greater.
func (c *ChainConfig) IsOpenMev(num *big.Int) bool {
	return isForked(c.IsOpenMevBlock, num)
}
